...
def process_image(image_path):
    ...
    for k, contour in enumerate(contours, start=1):
        ...
        # Labeling the object
        label_text = f"{k} Bulat" if metric > 0.8 else f"{k} Tidak "
        cv2.putText(labeled_image, label_text, (cX - 20, cY - 21), cv2.FONT_HERSHEY_SIMPLEX, 0.21, (255, 0, 0), 1,6)
